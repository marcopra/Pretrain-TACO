...
case $cuda_device in
    0|3)
        model_path="models/exp/33/taco_MT_MT50_OOD_Basketball_0.33_lr\=0.0001_ts\=178176000_curl_rew_best.pt"
        wandb_tag="33_BASKETBALL"
        gpu_device="$cuda_device"
        ;;
    1|4)
        model_path="models/exp/66/taco_MT_MT50_OOD_Basketball_0.66_lr\=0.0005_ts\=8550400_curl_rew_best.pt"
        wandb_tag="66_BASKETBALL"
        gpu_device="$cuda_device"
        ;;
    2|5)
        model_path="models/exp/99/taco_MT_MT50_OOD_Basketball_0.99_lr\=0.0005_ts\=3430400_curl_rew_best.pt"

...
for i in $(seq 1 $num_runs); do
    ...
    python3 train_metaworld.py agent.pretrained_path="/home/mprattico/Pretrain-TACO/models/${model_path}"  exp_name="/home/mprattico/Pretrain-TACO/models/${model_path}" seed=1 env_name=button-press-v2 random_init=true random_goal=false wandb_tag=MT${model_num}${wandb_suffix} num_train_frames=220000 device=cuda:${cuda_device} agent.no_taco=${no_taco}

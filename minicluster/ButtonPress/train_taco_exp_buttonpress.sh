...
case $cuda_device in
    0|3)
        model_path="models/exp/33/taco_MT_MT50_OOD_ButtonPress_0.33_lr\=0.0005_ts\=199014400_curl_rew_best.pt"
        wandb_tag="33_BUTTONPRESS"
        gpu_device="$cuda_device"
        ;;
    1|4)
        model_path="models/exp/66/taco_MT_MT50_OOD_ButtonPress_0.66_lr\=1e-05_ts\=614400_curl_rew_best.pt"
        wandb_tag="66_BUTTONPRESS"
        gpu_device="$cuda_device"
        ;;
    2|5)
        model_path="models/exp/99/taco_MT_MT50_OOD_ButtonPress_0.99_lr\=0.0005_ts\=30515200_curl_rew_best.pt"

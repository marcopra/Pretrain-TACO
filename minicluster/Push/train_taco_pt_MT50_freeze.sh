...
for i in $(seq 1 $num_runs); do
    ...
    python3 train_metaworld.py agent.pretrained_path="/home/mprattico/Pretrain-TACO/models/taco_MT_MT50_OOD_Push_0.${exp}_lr\=0.0005_ts\=${ts_value}_curl_rew.pt"  exp_name="/home/mprattico/Pretrain-TACO/models/taco_MT_MT50_OOD_Push_0.${exp}_lr\=0.0005_ts\=${ts_value}_curl_rew.pt" seed=1 env_name=push-v2 random_init=true random_goal=false wandb_tag=MT50${wandb_suffix} num_train_frames=220000 device=cuda:${cuda_device} agent.freeze_encoder=${freeze_encoder}

...
for i in $(seq 1 $num_runs); do
    ...
    python3 train_metaworld.py exp_name=baseline${cuda_device} seed=1 env_name=push-v2 random_init=true random_goal=false wandb_tag=baseline num_train_frames=300000 device=cuda:${cuda_device} agent.no_taco=${no_taco}

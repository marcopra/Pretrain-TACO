...
class Workspace:
    ...
    def setup(self):
        ...
        self.train_env = cdmc.make(self.cfg.task_name, self.cfg.obs_type, self.cfg.frame_stack,
                                self.cfg.action_repeat, self.cfg.seed)
        self.eval_env = cdmc.make(self.cfg.task_name, self.cfg.obs_type, self.cfg.frame_stack,
                                self.cfg.action_repeat, self.cfg.seed)
...
@hydra.main(config_path='cfgs', config_name='config_cdmc')
def main(cfg):
    from pathlib import Path
    if cfg.use_wandb:
        wandb.tensorboard.patch(root_logdir=str(Path.cwd()))
    from train_cdmc import Workspace as W
    root_dir = Path.cwd()
    workspace = W(cfg)

...
python3 train_metaworld.py --config-name config_drqv2metaworld agent.pretrained_path=none exp_name=$EXP_NAME seed=$SEED_ARG env_name=$ENV_NAME random_init=$RANDOM_HAND random_goal=$RANDOM_GOAL wandb_tag="baseline" num_train_frames=220000

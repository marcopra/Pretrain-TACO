...
class DrQV2Agent:
    def __init__(self, obs_shape, action_shape, device, lr, feature_dim,
        ...
        self.actor = Actor(obs_shape, action_shape, feature_dim,
                           hidden_dim).to(device)

        self.critic = Critic(obs_shape, action_shape, feature_dim, hidden_dim).to(device)
        self.critic_target = Critic(obs_shape, action_shape, feature_dim, hidden_dim).to(device)

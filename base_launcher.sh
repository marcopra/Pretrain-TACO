...
python3 train_metaworld.py exp_name=prova random_init=true device=cuda:0 agent.freeze_encoder=true agent.pretrained_path="/home/mprattico/Pretrain-TACO/models/debug/taco_MT_ST50_0.0_lr\=0.0005_ts\=5000192.pt" 

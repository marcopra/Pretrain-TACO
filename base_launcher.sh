...
python pretrain_taco_multi_task.py --dataset_config "mt_config/ST50/ST50_exp=20_1OOD_push_config.json" --use_wandb --total_steps 300_000_000 --checkpoint "20_000_000,200_000_000" --lr 1e-4

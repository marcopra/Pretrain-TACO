...
python pretrain_taco_multi_task2.py --dataset_config "mt_config/debug.json" --use_wandb --total_steps 300_000_000 --checkpoint "1_000_000, 2_000_000, 20_000_000,200_000_000" --lr 5e-3 --save_path "models/debug/"

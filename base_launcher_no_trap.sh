...
python train_metaworld.py agent=taco_resnet agent.pretrained_path="mvp" exp_name="prova" seed=820 env_name=push-v2 random_init=true random_goal=false wandb_tag=RESNET50-FREEZE num_train_frames=220000 agent.freeze_encoder=true batch_size=256  use_wandb=false
...
python pretrain_taco_multi_task_episodes.py --dataset_config "data_episodes/ST50/0.66" --use_wandb --total_steps 300_000_000 --checkpoint "50_000_000, 100_000_000, 200_000_000" --lr 5e-4

...
class ReplayBuffer(IterableDataset):
    def __init__(self, replay_dir, max_size, num_workers, nstep, multistep, 
                 discount, fetch_every, save_snapshot, rank=0, world_size=1):
        self._replay_dir = replay_dir
        self._size = 0
...
def make_replay_loader(replay_dir, max_size, batch_size, num_workers,
                       save_snapshot, nstep, multistep, discount, rank=0, world_size=1):
    ...
    print(f"Replay buffer size: {len(iterable)} for rank {rank} of {world_size}")

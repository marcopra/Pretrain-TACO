...
class OfflineReplayBuffer(IterableDataset):
    def __init__(self, dataset_paths, multistep=1, nstep=1, discount=0.99, split='train', train_ratio=0.8, fastwork=False):
        ...
        print(f"Loading datasets for {dataset_paths} split")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_config', type=str, required=True, help='Path to the dataset file')
    ...
    parser.add_argument('--train_ratio', type=float, default=0.0, help='Ratio of data to use for training')
    ...
    eval_dataloader = make_offline_replay_loader(
        test_dataset, 
        args.batch_size, 
        multistep=args.multistep, 
        nstep=args.nstep,

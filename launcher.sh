...
for env in $envs; do
    for prob in $exp_probs; do
        ...
        tmux send-keys -t "session$session_id" "python metaworld2_image_dataset.py --env_names $env --dataset_size 10000 --expert_probs $prob --action_repeat 2" C-m
